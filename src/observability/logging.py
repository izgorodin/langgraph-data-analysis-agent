...
class LGDALogger:
    ...
    def _log_structured(self, level: str, event: str, **kwargs):
        ...
        try:
            ...
            basic_logger.error(
                f"Structured logging failed: {e}, original event: {event}"
            )
    ...
    def log_security_event(
        ...
        self._log_structured(
            severity.upper(), "security_event", event_type=event_type, **details
        )
    ...
    def log_business_metric(
        ...
        context = {"metric_name": metric_name, "value": value}
        if dimensions:
            context.update(dimensions)

        self._log_structured("INFO", "business_metric", **context)
    ...
    def log_performance_metric(
        ...
        self._log_structured("INFO", "performance_metric", **context)
    ...
    def log_audit_trail(
        ...
        self._log_structured("INFO", "audit_trail", **context)
...
class TimedOperation:
    ...
    def __init__(
        self, logger: LGDALogger, operation: str, log_level: str = "INFO", **context
    ):
        self.logger = logger
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        if self.start_time is not None:
            ...
            self.logger.log_performance_metric(
                ...
                duration=duration,
                resource_usage={"success": success, "error": error, **self.context},
            )
