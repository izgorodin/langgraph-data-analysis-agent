...
class TableAccessError(SQLValidationError):
    ...
    def __init__(
        self, message: str, forbidden_tables: set[str], sql: str = "", details: str = ""
    ):
...
class StatementTypeError(SQLValidationError):
    ...
    def __init__(
        self, message: str, statement_type: str, sql: str = "", details: str = ""
    ):
...
class InjectionAttemptError(SecurityViolationError):
    ...
    def __init__(
        self, message: str, injection_type: str, sql: str = "", details: str = ""
    ):
