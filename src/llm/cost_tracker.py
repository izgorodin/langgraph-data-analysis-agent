...
class CostTracker:
    ...
    def track_request_cost(self, provider: LLMProvider, actual_cost: float) -> None:
        ...
        self.cost_per_provider[provider] = (
            self.cost_per_provider.get(provider, 0.0) + actual_cost
        )
    ...
    def get_cost_breakdown(self) -> Dict[str, float]:
        ...
        self._reset_if_needed()
        return {
            provider.value: cost for provider, cost in self.cost_per_provider.items()
        }
    ...
    def get_usage_stats(self) -> Dict[str, any]:
        ...
        return {
            ...
            "requests_by_provider": {
                provider.value: count for provider, count in self.request_count.items()
            },
