...
class TestLLMClient:
    ...
    def test_llm_completion_with_system_prompt(self, mock_gemini_client, sample_llm_responses):
        ...
        call_args = mock_gemini_client.GenerativeModel.return_value.generate_content.call_args[0][0]
    ...
    def test_llm_completion_sql_generation(self, mock_gemini_client, sample_llm_responses):
        ...
        assert any(keyword in result.upper() for keyword in ["SELECT", "FROM", "WHERE", "GROUP BY"])

    def test_llm_completion_plan_generation(self, mock_gemini_client, sample_llm_responses):
    ...
    def test_llm_completion_report_generation(self, mock_gemini_client, sample_llm_responses):
        ...
        assert any(word in result.lower() for word in ["revenue", "sales", "insights", "analysis"])
    ...
    def test_llm_completion_empty_response(self, mock_gemini_client):
        ...
        mock_gemini_client.GenerativeModel.return_value.generate_content.return_value = mock_response
    ...
    def test_llm_completion_api_key_configuration(self, mock_gemini_client, mock_env_vars):
    ...
    def test_llm_completion_error_handling(self, mock_gemini_client):
        ...
        # Mock API error
        mock_gemini_client.GenerativeModel.return_value.generate_content.side_effect = Exception("API Error")
    ...
    def test_llm_completion_rate_limiting(self, mock_gemini_client):
        ...
        mock_gemini_client.GenerativeModel.return_value.generate_content.side_effect = rate_limit_error
    ...
    def test_llm_completion_authentication_error(self, mock_gemini_client):
        ...
        mock_gemini_client.GenerativeModel.return_value.generate_content.side_effect = auth_error
    ...
    def test_llm_completion_quota_exceeded(self, mock_gemini_client):
        ...
        mock_gemini_client.GenerativeModel.return_value.generate_content.side_effect = quota_error
    ...
    def test_llm_completion_special_characters(self, mock_gemini_client, sample_llm_responses):
    ...
    def test_llm_completion_unicode_characters(self, mock_gemini_client, sample_llm_responses):
    ...
    def test_llm_completion_json_prompt_response(self, mock_gemini_client, sample_llm_responses):
    ...
    def test_llm_completion_concurrent_requests(self, mock_gemini_client, sample_llm_responses):
    ...
    def test_llm_completion_prompt_injection_safety(self, mock_gemini_client, sample_llm_responses):
    ...
    def test_llm_completion_model_parameter_validation(self, mock_gemini_client, mock_env_vars):
