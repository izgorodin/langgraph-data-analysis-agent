...
class TestBusinessMetric:
    ...
    def test_business_metric_with_data(self):
        ...
        metric = BusinessMetric(
            "test_metric", 2.5, dimensions=dimensions, metadata=metadata
        )
    ...
    def test_business_metric_to_dict(self):
        ...
        metric = BusinessMetric(
            "test_metric", 1.0, dimensions={"key": "value"}, metadata={"meta": "data"}
        )
...
class TestBusinessMetrics:
    ...
    def test_track_insight_quality(self):
        ...
        assert (
            low_quality.dimensions["quality_category"] == "poor"
        )  # 0.3 maps to "poor"
    ...
    def test_track_resource_efficiency(self):
        ...
        efficiency_metric = next(
            m for m in metrics.metrics_buffer if m.metric_name == "resource_efficiency"
        )
    ...
    def test_track_pipeline_performance(self):
        ...
        metrics.track_pipeline_performance(
            stage="execute_sql", duration=5.5, success=True, memory_usage=1024000
        )
    ...
    def test_get_session_summary(self):
        ...
        assert (
            "medium" in summary["complexity_range"]
        )  # Check the complexity range instead
